...
# Initialize OpenAI client
#client = OpenAI() # openAI api key is stored in zshrc for now 
...
# Streamlit UI
st.title("Pharmallm Bot")

st.sidebar.title("Navigate")
page = st.sidebar.radio("Go to", ["Upload & Process", "Summarize Content"])
...
# Page 2: Summarize Content
if page == "Summarize Content":
